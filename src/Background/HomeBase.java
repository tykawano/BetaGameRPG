...
public class HomeBase extends Super_Level{
    ...
    private void putInHouse(){
        ...
        // door
        putInTextureHelper(villageSet[38],4*gp.size,14*gp.size + gp.halfTile + 10);
    }
    ...
    public int[][] setupMap(){
        ...
        return new int[][]{
                ...
                {42,43,42,10,42,10,10,51,58,66,10,10,10,10,10,10,10,43,50,70,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10},
    ...
    private void putInBackgroundTiles() {
        ...
        for (int i = 0; i < mapLevel.length; i++) {
            for (int j = 0; j < mapLevel[i].length; j++) {
                ...
                putInTextureHelper(baseTileSet[currNum],worldWidthPixel,worldHeightPixel);
            }
        }
    }
